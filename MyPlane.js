...
export class MyPlane extends CGFobject {
    constructor(scene, nrDivs, minS, maxS, minT, maxT) {
        ...
        // Texture coordinate bounds with defaults
        this.minS = minS || 0;
        this.maxS = maxS || 1;
        this.minT = minT || 0;
        this.maxT = maxT || 1;
        
        // Calculate texture coordinate increments per division
    ...
    initBuffers() {
        ...
        // Generate grid vertices from top-left to bottom-right
        var yCoord = 0.5;
        ...
        // Generate triangle strip indices for efficient rendering
        this.indices = [];
        var ind = 0;
        for (var j = 0; j < this.nrDivs; j++) {
            for (var i = 0; i <= this.nrDivs; i++) {
            ...
            // Add degenerate triangles between strips (except for last strip)
            if (j + 1 < this.nrDivs) {
